...
struct TestingPeriodView_Previews: PreviewProvider {
    static var previews: some View {
        TestingPeriodView(users: userCardstestingPeriod)
    }
}
